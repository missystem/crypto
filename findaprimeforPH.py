...
def main():
    ...
    p = findPrimeNumber(60)
    # p = 1213833098980537393
    # p = 1714234396500634927
    # p = 1566692760969186863
    # p = 1579249337851910149
    g = primitive_root(p)
    ...
    print(f"Calculating for {p} by using Pohlig Hellman took {(time_stop-time_start).__round__(3)} seconds")
